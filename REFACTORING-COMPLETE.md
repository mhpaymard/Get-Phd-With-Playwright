...
https://applycore.ca/phd/api/health    → Health Check
https://applycore.ca/phd/api/phd/search → Search PhDs
https://applycore.ca/phd/api/crawler/status → Crawler Status
```
...
اگه سوالی دارید:
1. **مستندات:** پوشه `docs/`
2. **Swagger UI:** https://applycore.ca/phd/api-docs
3. **README:** README.md
