...
interface TestConfig<TestArgs = {}, WorkerArgs = {}> {
   ...
   * `8080` produces `baseURL` equal `https://applycore.ca:8080`. If `webServer` is specified as an array, you must
   ...
   *     url: 'https://applycore.ca:3000',
   *     timeout: 120 * 1000,
   *     reuseExistingServer: !process.env.CI,
   *   },
   *   use: {
   *     baseURL: 'https://applycore.ca:3000/',
   *   },
   * });
   * ```
   *
   ...
   *   // This will result in https://applycore.ca:3000/foo
   *   await page.goto('/foo');
   * });
   * ```
   *
