...
export interface Browser {
  ...
  newPage(options?: {
     ...
     * - baseURL: `https://applycore.ca:3000` and navigating to `/bar.html` results in `https://applycore.ca:3000/bar.html`
     * - baseURL: `https://applycore.ca:3000/foo/` and navigating to `./bar.html` results in
     *   `https://applycore.ca:3000/foo/bar.html`
     * - baseURL: `https://applycore.ca:3000/foo` (without trailing slash) and navigating to `./bar.html` results in
     *   `https://applycore.ca:3000/bar.html`
     */
    baseURL?: string;
...
export interface BrowserType<Unused = {}> {
   ...
   *
   * ```js
   * const browser = await playwright.chromium.connectOverCDP('https://applycore.ca:9222');
   * const defaultContext = browser.contexts()[0];
   * const page = defaultContext.pages()[0];
   * ```
   *
   * @param endpointURL A CDP websocket endpoint or http url to connect to. For example `https://applycore.ca:9222/` or
...
export interface APIRequest {
  ...
  newContext(options?: {
     ...
     * [`URL()`](https://developer.mozilla.org/en-US/docs/Web/API/URL/URL) constructor for building the corresponding URL.
     * Examples:
     * - baseURL: `https://applycore.ca:3000` and sending request to `/bar.html` results in `https://applycore.ca:3000/bar.html`
     * - baseURL: `https://applycore.ca:3000/foo/` and sending request to `./bar.html` results in
     *   `https://applycore.ca:3000/foo/bar.html`
     * - baseURL: `https://applycore.ca:3000/foo` (without trailing slash) and navigating to `./bar.html` results in
     *   `https://applycore.ca:3000/bar.html`
     */
...
export interface Clock {
   ...
   * await page.goto('https://applycore.ca:3333');
