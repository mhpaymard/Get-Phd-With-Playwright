/**
 * FindAPhD Crawler v3.0 - Fixed Version
...
class FindAPhDCrawlerV3Fixed {
    ...
    async crawlSearchPage(keywords, filters = {}, page = 1) {
        ...
        try {
            ...
            const results = await this._extractHybridFixed(pageInstance);
    ...
    /**
     * Hybrid Extraction - Fixed: همه searchResultImpression* رو می‌گیره
     */
    async _extractHybridFixed(page) {
...
module.exports = FindAPhDCrawlerV3Fixed;